...
class TestProviderIntegration:
    ...
    @patch.dict(os.environ, {"GOOGLE_ALLOWED_MODELS": "gemini-3-flash-preview,flash"})
...
class TestCustomProviderOpenRouterRestrictions:
    ...
    def test_custom_provider_respects_openrouter_restrictions(self):
        ...
        assert provider.validate_model_name("gemma3")
...
class TestShorthandRestrictions:
    ...
    @patch.dict(
        os.environ,
        {"OPENAI_ALLOWED_MODELS": "mini,o4-mini", "GOOGLE_ALLOWED_MODELS": "flash,gemini-3-flash-preview"},
    )
...
class TestAutoModeWithRestrictions:
    ...
    def test_fallback_with_shorthand_restrictions(self, monkeypatch):
        ...
        try:
            ...
            assert model in ["mini", "gpt-5-mini", "o4-mini", "gemini-3-flash-preview", "gemini-2.5-flash"]
        finally:
